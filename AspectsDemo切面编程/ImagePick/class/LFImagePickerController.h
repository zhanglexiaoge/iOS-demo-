...
/**
 ...
 @param results 回调对象
 */
- (void)lf_imagePickerController:(LFImagePickerController *)picker didFinishPickingResult:(NSArray <LFResultObject /* <LFResultImage/LFResultVideo> */*> *)results didFinishPhotoModelArr:(NSArray <PhotoModel *> *)photoModelArray andisSelectOriginalPhoto:(BOOL)isSelectOriginalPhoto;
